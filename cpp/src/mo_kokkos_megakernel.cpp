            ...
            for (size_t col = col_start; col < col_end; ++col) {
                ...
                for (size_t gp = 0; gp < gpoints; ++gp) {
                    ...
                    for (size_t lay = 0; lay < layers; ++lay) {
                        ...
                        // a. Compute jtemp, jpress, and interpolation weights fmajor(2,2,2) and fminor(2,2)
                        ...
                        // b. Interpolate major and minor gas absorption
                        real_t k_val = 0.0;
                        if (kmajor_ptr) {
                            for (int i = 0; i < 2; ++i) {
                                for (int j = 0; j < 2; ++j) {
                        ...
                        // c. Total optical depth
                        tau_tot_arr[lay] = tau_gas + tau_cloud + tau_aero;

                        // d. Layer Planck source functions
                        if (planck_ptr) {
                    ...
                    // e. Longwave non-scattering radiative transport sweep
